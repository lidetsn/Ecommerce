...
import {listProductDetails,backToProducts,createProductReview} from "../actions/productActions"
...
const ProductScreen = ({history,match}) => {
       ...
       const [comment,setComment]=useState("")
        ...
        useEffect(()=>{
            ...
            //     }
            //     fetchProduct()
        },[dispatch,match,successProductReview,errorProductReview])//add match here to avod warning in running server 
